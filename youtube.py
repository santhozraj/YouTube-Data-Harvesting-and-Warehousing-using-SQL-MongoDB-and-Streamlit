...
def channel_details(channel_id):
    ...
    vi_id_details=get_video_ids(channel_id)
...
# TABLE CREATION FOR CHANNEL,PLAYLIST,VIDEOS,COMMENT
...
if question=='1. What are the names of all the videos and their corresponding channels?':
    query1='''select title as videos,channel_name as channalname from videos'''
    ...
    query2='''select channel_name as channelname,total_videos as no_videos from channels order by
                total_videos desc'''
    ...
    mydb.commit()
    t10=cursor.fetchall()
    df10=pd.DataFrame(t10,columns=["video title","channal name","comments"])
    st.write(df10)
